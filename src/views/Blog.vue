                ...
                <div class="col-md-12">
                  ...
                  >
                    <a
                      ...
                      class="img img-2"
                      style="
                        background-image: url(images/ximage_1.jpg.pagespeed.ic.bP9m1ezc08.webp);
                      "
                    ></a>
                    <div class="text text-2 pl-md-4">
                      ...
                      <div class="meta-wrap">
                        <p class="meta">
                          <span
                            ><i class="icon-calendar mr-2"></i>June 28,
                            2019</span
                          >
                          <span
                            ><a href="single.html"
                          ...
                          >
                          <span
                            ><i class="icon-comment2 mr-2"></i>5 Comment</span
                          >
                        </p>
                      </div>
                      <p class="mb-4">
                      ...
                      <div
                        ...
                        data-href="https://www.facebook.com/louisemarieachille/posts/3020461548278484"
                        data-width="560"
              ...
              <div class="sidebar-box ftco-animate fadeInUp ftco-animated">
                ...
                <div class="block-21 mb-4 d-flex">
                  <a
                    class="blog-img mr-4"
                    style="
                      background-image: url(images/ximage_2.jpg.pagespeed.ic.Bj2SSShAni.webp);
                    "
                  ></a>
                  <div class="text"></div>
                </div>
                <div class="block-21 mb-4 d-flex">
                  <a
                    class="blog-img mr-4"
                    style="
                      background-image: url(images/ximage_3.jpg.pagespeed.ic.GG-cYs-yp6.webp);
                    "
                  ></a>
                  <div class="text">
                    <h3 class="heading">
                    ...
                    <div class="meta">
                      <div>
                        <a href="#"
                          ><span class="icon-calendar"></span> June 28, 2019</a
                        >
                      </div>
                      <div>
                        <a href="#"
...
#ftco-loader {
  ...
  -webkit-box-shadow: 0 24px 64px rgb(0 0 0 / 24%);
